...
(function () {
  ...
  var _J = function _J(instance, Constructor) {
  ...
  var _1E = function _1E(link) {
    this.setLink(link);
    this.rewriteFlag = _F.SEARCH;
  };

  var _3r = function _3r(obj) {
  ...
  var _3K = function _3K(self, call) {
    var __captured__scope_4 = __scope_0[3] || __get_scope_binding_0(3);
  ...
  var _b = function _b(ctx, id, param, body) {
    var __captured__scope_4 = __scope_0[3] || __get_scope_binding_0(3);
  ...
  var _3k = function _3k(instance, Constructor) {
    if (!(instance instanceof Constructor)) {
      throw new TypeError("Cannot call a class as a function");
    }
  };

  var _2q = function _2q(type, value, pred) {
    _3k(this, _2q);
  ...
  var _1M = function _1M(type) {
    return this._token.type == type;
  };

  var _1N = function _1N(type) {
    if (this.next(type)) {
      this._nextToken();
  ...
  var _1Q = function _1Q(ctx, thunk) {
    if (thunk) {
  ...
  var _1T = function _1T(ctx, type, thunk) {
    var args = [];
  ...
  var _2b = function _2b(instance, Constructor) {
    if (!(instance instanceof Constructor)) {
      throw new TypeError("Cannot call a class as a function");
    }
  };

  var _W = function _W(from, to, fromPort, toPort, colour) {
    _2b(this, _W);
  ...
  var _1l = function _1l(graph) {
    if (graph != null) graph.addLink(this);
    this.graph = graph;
    return this; // to provide chain operation
  };

  var _1m = function _1m(group) {
    group.addLink(this);
    this.group = group;
    return this; // to provide chain operation
  };

  var _1n = function _1n(group) {
    this.group.removeLink(this);
    this.addToGroup(group);
    return this;
  };

  var _1o = function _1o(key, port) {
    var fromNode = this.graph.findNodeByKey(this.from);
  ...
  var _3G = function _3G(instance, Constructor) {
    if (!(instance instanceof Constructor)) {
      throw new TypeError("Cannot call a class as a function");
    }
  };
  ...
  var _3J = function _3J(target, property, receiver) {
    var __captured__scope_H = __scope_0[16] || __get_scope_binding_0(16);
  ...
  var _4I = function _4I(object, property) {
    var __captured__scope_H = __scope_0[16] || __get_scope_binding_0(16);
  ...
  var _3A = function _3A(instance, Constructor) {
    if (!(instance instanceof Constructor)) {
      throw new TypeError("Cannot call a class as a function");
    }
  };

  var _1j = function _1j(shape, text, name) {
    _3A(this, _1j);
  ...
  var _1X = function _1X(graph) {
    if (graph != null) graph.addNode(this);
    this.graph = graph;
    return this; // to provide chain operation
  };

  var _1Y = function _1Y(group) {
    group.addNode(this);
    this.group = group;
    return this; // to provide chain operation
  };

  var _1Z = function _1Z(group) {
    this.group.removeNode(this);
    this.addToGroup(group);
    return this;
  };

  var _1a = function _1a() {
    return this.links;
  };

  var _1b = function _1b() {
    var links = [];
  ...
  var _1h = function _1h(token, link) {
    return link;
  };

  var _1i = function _1i(token, nextLink) {
    token.rewrite = false;
    return nextLink;
  };
  ...
  var _20 = function _20(node) {
    this.nodes.push(node);
  };

  var _21 = function _21(node) {
    return this.nodes.splice(this.nodes.indexOf(node), 1);
  };

  var _22 = function _22(link) {
    this.links.push(link);
  };

  var _23 = function _23(link) {
  ...
  var _17 = function _17(key) {
    return this.allNodes.get(key);
  };

  var _18 = function _18(link) {
    this.allLinks.push(link);
  };

  var _19 = function _19(link) {
    this.allLinks.splice(this.allLinks.indexOf(link), 1);
  };

  var _1A = function _1A(from, to) {
  ...
  var _1B = function _1B(width, height) {
  ...
  var _2c = function _2c(instance, Constructor) {
    if (!(instance instanceof Constructor)) {
      throw new TypeError("Cannot call a class as a function");
    }
  };
  ...
  var _3F = function _3F(target, property, receiver) {
    var __captured__scope_3 = __scope_0[2] || __get_scope_binding_0(2);
  ...
  var _4H = function _4H(object, property) {
    var __captured__scope_3 = __scope_0[2] || __get_scope_binding_0(2);
  ...
  var _1v = function _1v(prin, auxs) {
    this.prin = prin;
    this.auxs = auxs;
    return this;
  };

  var _1w = function _1w() {
    this.boxed = true;
    return this.prin;
  };
  ...
  var _3O = function _3O(self, call) {
    var __captured__scope_6 = __scope_0[5] || __get_scope_binding_0(5);
  ...
  var _3M = function _3M(self, call) {
    var __captured__scope_5 = __scope_0[4] || __get_scope_binding_0(4);
  ...
  var _3i = function _3i(self, call) {
    var __captured__scope_G = __scope_0[15] || __get_scope_binding_0(15);
  ...
  var _13 = function _13(name, active) {
    var __captured__scope_G = __scope_0[15] || __get_scope_binding_0(15);
  ...
  var _28 = function _28(token, link) {
    if (link.to == this.key) {
      return this.findLinksOutOf(null)[0];
    }
  };

  var _29 = function _29(token) {
    var link = token.link;
  ...
  var _2A = function _2A() {
    return new _f(this.name);
  };

  var _2B = function _2B(level) {
    return level + this.key + '[shape=' + this.shape + '];';
  };

  var _2C = function _2C(cs, inputs, originalGroup, op) {
    var c;
    var from;
    var to;
    var cList = [];
  ...
  var _2a = function _2a(instance, Constructor) {
    if (!(instance instanceof Constructor)) {
      throw new TypeError("Cannot call a class as a function");
    }
  };
  ...
  var _1U = function _1U(token) {
    return this.findLinksOutOf(null)[0];
  };

  var _1V = function _1V() {
    return new _T();
  };

  var _1W = function _1W(level) {
    return level + this.key + '[shape=' + this.shape + '];';
  };

  var _3x = function _3x(obj) {
  ...
  var _3Q = function _3Q(self, call) {
    var __captured__scope_7 = __scope_0[6] || __get_scope_binding_0(6);
  ...
  var _2h = function _2h(instance, Constructor) {
    if (!(instance instanceof Constructor)) {
      throw new TypeError("Cannot call a class as a function");
    }
  };

  var _3S = function _3S(self, call) {
    var __captured__scope_8 = __scope_0[7] || __get_scope_binding_0(7);
  ...
  var _2F = function _2F() {
    return new _n();
  };

  var _2G = function _2G(b) {
    if (b == "false" || b == 0) {
      return false;
    } else {
      return true;
  ...
  var _3U = function _3U(self, call) {
    var __captured__scope_9 = __scope_0[8] || __get_scope_binding_0(8);
  ...
  var _2H = function _2H() {
    return new _p();
  };

  var _2I = function _2I(token) {
    var _this = this;
  ...
  var _3W = function _3W(self, call) {
    var __captured__scope_A = __scope_0[9] || __get_scope_binding_0(9);
  ...
  var _2J = function _2J() {
    return new _r();
  };

  var _2K = function _2K(token) {
    var _this = this;
  ...
  var _3Y = function _3Y(self, call) {
    var __captured__scope_B = __scope_0[10] || __get_scope_binding_0(10);
  ...
  var _2L = function _2L() {
    return new _t();
  };

  var _2M = function _2M(token) {
    var _this = this;
  ...
  var _3a = function _3a(self, call) {
    var __captured__scope_C = __scope_0[11] || __get_scope_binding_0(11);
  ...
  var _3c = function _3c(self, call) {
    var __captured__scope_D = __scope_0[12] || __get_scope_binding_0(12);
  ...
  var _3e = function _3e(self, call) {
    var __captured__scope_E = __scope_0[13] || __get_scope_binding_0(13);
  ...
  var _3g = function _3g(self, call) {
    var __captured__scope_F = __scope_0[14] || __get_scope_binding_0(14);
  ...
  var _3 = function _3(graphSet, tokenSet, countSet) {
  ...
  var _6 = function _6(name, active) {
  ...
  var _8 = function _8(graphTxt, linkTxt, flagTxt) {
    if (!finished) {
      this.count++;
