...
const filename = '../../../viz/CBV-with-CBV-embedding/js/goi-machine.js';
// const filename = 'main.min.js';
const filePath = path.join(__dirname, filename);
let fileContents = fs.readFileSync(filePath, 'utf8');
if (filename !== 'main.min.js') {
    // if not using Webpack first, we need to define the require.js syntax and specifically optimize the defined function
    fileContents = `
...
const sourceMapContents = filename === 'main.min.js' ? fs.readFileSync(filePath + '.map', 'utf8') : undefined;
