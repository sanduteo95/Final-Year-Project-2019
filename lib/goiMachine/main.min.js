...
var __WEBPACK_LOCAL_MODULE_0__, __WEBPACK_LOCAL_MODULE_0__module;var __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_RESULT__;function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = (function (require) {
  ...
  function (_Term2) {
    ...
    function Operation(ctx, sig, name, active, eas, das) {
      ...
      _this2 = _possibleConstructorReturn(this, _getPrototypeOf(Operation).call(this, ctx));
      _this2.sig = sig;
      _this2.name = name;
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = (function (require) {
  ...
  function (_Term3) {
    ...
    function Thunk(ctx, inner) {
      ...
      _this3 = _possibleConstructorReturn(this, _getPrototypeOf(Thunk).call(this, ctx));
      _this3.inner = inner;
      return _this3;
    }
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = (function (require) {
  ...
  function (_Term4) {
    ...
    function Binding(ctx, id, param, body) {
      ...
      _this4 = _possibleConstructorReturn(this, _getPrototypeOf(Binding).call(this, ctx));
      _this4.id = id;
      _this4.param = param;
      _this4.body = body;
      return _this4;
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = (function (require) {
  ...
  function (_Term5) {
    ...
    function Reference(ctx, id, param, body) {
      ...
      _this5 = _possibleConstructorReturn(this, _getPrototypeOf(Reference).call(this, ctx));
      _this5.id = id;
      _this5.param = param;
      _this5.body = body;
      return _this5;
