...
/***/ "../itf-impl/Visualiser/js/ast/graphabstraction.js":
/*!*********************************************************!*\
  !*** ../itf-impl/Visualiser/js/ast/graphabstraction.js ***!
  \*********************************************************/
/*! no static exports found */
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! parser/pattern */ "../itf-impl/Visualiser/js/parser/pattern.js"), __webpack_require__(/*! ast/pattern */ "../itf-impl/Visualiser/js/ast/pattern.js"), __webpack_require__(/*! ast/abstraction */ "../itf-impl/Visualiser/js/ast/abstraction.js"), __webpack_require__(/*! ast/application */ "../itf-impl/Visualiser/js/ast/application.js"), __webpack_require__(/*! ast/identifier */ "../itf-impl/Visualiser/js/ast/identifier.js"), __webpack_require__(/*! ast/constant */ "../itf-impl/Visualiser/js/ast/constant.js"), __webpack_require__(/*! ast/operation */ "../itf-impl/Visualiser/js/ast/operation.js"), __webpack_require__(/*! ast/unary-op */ "../itf-impl/Visualiser/js/ast/unary-op.js"), __webpack_require__(/*! ast/binary-op */ "../itf-impl/Visualiser/js/ast/binary-op.js"), __webpack_require__(/*! ast/if-then-else */ "../itf-impl/Visualiser/js/ast/if-then-else.js"), __webpack_require__(/*! ast/recursion */ "../itf-impl/Visualiser/js/ast/recursion.js"), __webpack_require__(/*! ast/tuple */ "../itf-impl/Visualiser/js/ast/tuple.js"), __webpack_require__(/*! ast/provisional-constant */ "../itf-impl/Visualiser/js/ast/provisional-constant.js"), __webpack_require__(/*! ast/change */ "../itf-impl/Visualiser/js/ast/change.js"), __webpack_require__(/*! ast/assign */ "../itf-impl/Visualiser/js/ast/assign.js"), __webpack_require__(/*! ast/propagation */ "../itf-impl/Visualiser/js/ast/propagation.js"), __webpack_require__(/*! ast/deprecation */ "../itf-impl/Visualiser/js/ast/deprecation.js"), __webpack_require__(/*! ast/deref */ "../itf-impl/Visualiser/js/ast/deref.js"), __webpack_require__(/*! ast/graphabstraction */ "../itf-impl/Visualiser/js/ast/graphabstraction.js"), __webpack_require__(/*! parser/lexer */ "../itf-impl/Visualiser/js/parser/lexer.js"), __webpack_require__(/*! parser/parser */ "../itf-impl/Visualiser/js/parser/parser.js"), __webpack_require__(/*! token */ "../itf-impl/Visualiser/js/token.js"), __webpack_require__(/*! link */ "../itf-impl/Visualiser/js/link.js"), __webpack_require__(/*! graph */ "../itf-impl/Visualiser/js/graph.js"), __webpack_require__(/*! group */ "../itf-impl/Visualiser/js/group.js"), __webpack_require__(/*! term */ "../itf-impl/Visualiser/js/term.js"), __webpack_require__(/*! box-wrapper */ "../itf-impl/Visualiser/js/box-wrapper.js"), __webpack_require__(/*! nodes/expo */ "../itf-impl/Visualiser/js/nodes/expo.js"), __webpack_require__(/*! nodes/abs */ "../itf-impl/Visualiser/js/nodes/abs.js"), __webpack_require__(/*! nodes/app */ "../itf-impl/Visualiser/js/nodes/app.js"), __webpack_require__(/*! nodes/binop */ "../itf-impl/Visualiser/js/nodes/binop.js"), __webpack_require__(/*! nodes/const */ "../itf-impl/Visualiser/js/nodes/const.js"), __webpack_require__(/*! nodes/contract */ "../itf-impl/Visualiser/js/nodes/contract.js"), __webpack_require__(/*! nodes/der */ "../itf-impl/Visualiser/js/nodes/der.js"), __webpack_require__(/*! nodes/var */ "../itf-impl/Visualiser/js/nodes/var.js"), __webpack_require__(/*! nodes/if */ "../itf-impl/Visualiser/js/nodes/if.js"), __webpack_require__(/*! nodes/pax */ "../itf-impl/Visualiser/js/nodes/pax.js"), __webpack_require__(/*! nodes/promo */ "../itf-impl/Visualiser/js/nodes/promo.js"), __webpack_require__(/*! nodes/recur */ "../itf-impl/Visualiser/js/nodes/recur.js"), __webpack_require__(/*! nodes/start */ "../itf-impl/Visualiser/js/nodes/start.js"), __webpack_require__(/*! nodes/unop */ "../itf-impl/Visualiser/js/nodes/unop.js"), __webpack_require__(/*! nodes/weak */ "../itf-impl/Visualiser/js/nodes/weak.js"), __webpack_require__(/*! nodes/delta */ "../itf-impl/Visualiser/js/nodes/delta.js"), __webpack_require__(/*! nodes/set */ "../itf-impl/Visualiser/js/nodes/set.js"), __webpack_require__(/*! nodes/dep */ "../itf-impl/Visualiser/js/nodes/dep.js"), __webpack_require__(/*! nodes/deref */ "../itf-impl/Visualiser/js/nodes/deref.js"), __webpack_require__(/*! nodes/mod */ "../itf-impl/Visualiser/js/nodes/mod.js"), __webpack_require__(/*! nodes/prop */ "../itf-impl/Visualiser/js/nodes/prop.js"), __webpack_require__(/*! nodes/prov */ "../itf-impl/Visualiser/js/nodes/prov.js"), __webpack_require__(/*! nodes/pattuple */ "../itf-impl/Visualiser/js/nodes/pattuple.js"), __webpack_require__(/*! nodes/pair */ "../itf-impl/Visualiser/js/nodes/pair.js"), __webpack_require__(/*! nodes/gabs */ "../itf-impl/Visualiser/js/nodes/gabs.js"), __webpack_require__(/*! gc */ "../itf-impl/Visualiser/js/gc.js"), __webpack_require__(/*! helper */ "../itf-impl/Visualiser/js/helper.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (PatternType, Pattern, Abstraction, Application, Identifier, Constant, Operation, UnaryOp, BinaryOp, IfThenElse, Recursion, Tuple, ProvisionalConstant, Change, Assign, Propagation, Deprecation, Dereference, GraphAbstraction, Lexer, Parser, MachineToken, Link, Graph, Group, Term, BoxWrapper, Expo, Abs, App, BinOp, Const, Contract, Der, Var, If, Pax, Promo, Recur, Start, UnOp, Weak, Delta, Set, Dep, Deref, Mod, Prop, Prov, PatTuple, Pair, GAbs, GC, Helper) {
  var GoIMachine =
  /*#__PURE__*/
  function () {
    function GoIMachine() {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! node */ "../itf-impl/Visualiser/js/node.js"), __webpack_require__(/*! token */ "../itf-impl/Visualiser/js/token.js"), __webpack_require__(/*! link */ "../itf-impl/Visualiser/js/link.js"), __webpack_require__(/*! box-wrapper */ "../itf-impl/Visualiser/js/box-wrapper.js"), __webpack_require__(/*! nodes/promo */ "../itf-impl/Visualiser/js/nodes/promo.js"), __webpack_require__(/*! nodes/const */ "../itf-impl/Visualiser/js/nodes/const.js"), __webpack_require__(/*! op */ "../itf-impl/Visualiser/js/op.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (Node, Token, Link, BoxWrapper, Promo, Const, Op) {
  var CompData = Token.CompData();
  var RewriteFlag = Token.RewriteFlag();
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! node */ "../itf-impl/Visualiser/js/node.js"), __webpack_require__(/*! token */ "../itf-impl/Visualiser/js/token.js"), __webpack_require__(/*! nodes/promo */ "../itf-impl/Visualiser/js/nodes/promo.js"), __webpack_require__(/*! nodes/weak */ "../itf-impl/Visualiser/js/nodes/weak.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (Node, Token, Promo, Weak) {
  var CompData = Token.CompData();
  var RewriteFlag = Token.RewriteFlag();
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! node */ "../itf-impl/Visualiser/js/node.js"), __webpack_require__(/*! token */ "../itf-impl/Visualiser/js/token.js"), __webpack_require__(/*! nodes/delta */ "../itf-impl/Visualiser/js/nodes/delta.js"), __webpack_require__(/*! nodes/weak */ "../itf-impl/Visualiser/js/nodes/weak.js"), __webpack_require__(/*! nodes/contract */ "../itf-impl/Visualiser/js/nodes/contract.js"), __webpack_require__(/*! helper */ "../itf-impl/Visualiser/js/helper.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (Node, Token, Delta, Weak, Contract, Helper) {
  var CompData = Token.CompData();
  var RewriteFlag = Token.RewriteFlag();
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! node */ "../itf-impl/Visualiser/js/node.js"), __webpack_require__(/*! token */ "../itf-impl/Visualiser/js/token.js"), __webpack_require__(/*! link */ "../itf-impl/Visualiser/js/link.js"), __webpack_require__(/*! box-wrapper */ "../itf-impl/Visualiser/js/box-wrapper.js"), __webpack_require__(/*! nodes/promo */ "../itf-impl/Visualiser/js/nodes/promo.js"), __webpack_require__(/*! nodes/const */ "../itf-impl/Visualiser/js/nodes/const.js"), __webpack_require__(/*! ast/pattern */ "../itf-impl/Visualiser/js/ast/pattern.js"), __webpack_require__(/*! nodes/contract */ "../itf-impl/Visualiser/js/nodes/contract.js"), __webpack_require__(/*! nodes/pattuple */ "../itf-impl/Visualiser/js/nodes/pattuple.js"), __webpack_require__(/*! term */ "../itf-impl/Visualiser/js/term.js"), __webpack_require__(/*! nodes/weak */ "../itf-impl/Visualiser/js/nodes/weak.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (Node, Token, Link, BoxWrapper, Promo, Const, PatternType, Contract, PatTuple, Term, Weak) {
  var CompData = Token.CompData();
  var RewriteFlag = Token.RewriteFlag();
      ...
      value: function rewrite(token, nextLink) {
        if (token.rewriteFlag == RewriteFlag.F_PAIR && nextLink.from == this.key) {
          ...
          if (prev instanceof Contract) {
            ...
            if (prev2 instanceof PatTuple) {
              if (token.link.fromPort == "e") {
                var right = this.graph.findNodeByKey(this.findLinksOutOf("e")[0].to);

                if (right instanceof Promo) {
                  ...
                  if (inLinks.length == 1) {// this will not happen as the C-node should have taken care of it
                    ...
                    Term.joinAuxs(right.group.auxs, newBoxWrapper.auxs, newBoxWrapper.group);
                    var prevLink = prev2.findLinksInto("e")[0];
                    prevLink.changeTo(newBoxWrapper.prin.key, "s");
                    var weak = new Weak(null).addToGroup(this.group);
                    new Link(weak.key, prev2.key, "n", "e").addToGroup(this.group);
                  }
                ...
                if (left instanceof Promo) {
                  ...
                  if (inLinks.length == 1) {// this will not happen as the C-node should have taken care of it
                    ...
                    Term.joinAuxs(left.group.auxs, newBoxWrapper.auxs, newBoxWrapper.group);
                    var prevLink = prev2.findLinksInto("w")[0];
                    prevLink.changeTo(newBoxWrapper.prin.key, "s");
                    var weak = new Weak(null).addToGroup(this.group);
                    new Link(weak.key, prev2.key, "n", "w").addToGroup(this.group);
                  }
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! token */ "../itf-impl/Visualiser/js/token.js"), __webpack_require__(/*! term */ "../itf-impl/Visualiser/js/term.js"), __webpack_require__(/*! link */ "../itf-impl/Visualiser/js/link.js"), __webpack_require__(/*! nodes/expo */ "../itf-impl/Visualiser/js/nodes/expo.js"), __webpack_require__(/*! nodes/der */ "../itf-impl/Visualiser/js/nodes/der.js"), __webpack_require__(/*! nodes/contract */ "../itf-impl/Visualiser/js/nodes/contract.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (Token, Term, Link, Expo, Der, Contract) {
  var CompData = Token.CompData();
  var RewriteFlag = Token.RewriteFlag();
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! node */ "../itf-impl/Visualiser/js/node.js"), __webpack_require__(/*! token */ "../itf-impl/Visualiser/js/token.js"), __webpack_require__(/*! nodes/mod */ "../itf-impl/Visualiser/js/nodes/mod.js"), __webpack_require__(/*! nodes/const */ "../itf-impl/Visualiser/js/nodes/const.js"), __webpack_require__(/*! link */ "../itf-impl/Visualiser/js/link.js"), __webpack_require__(/*! helper */ "../itf-impl/Visualiser/js/helper.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (Node, Token, Mod, Const, Link, Helper) {
  var CompData = Token.CompData();
  var RewriteFlag = Token.RewriteFlag();
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! node */ "../itf-impl/Visualiser/js/node.js"), __webpack_require__(/*! token */ "../itf-impl/Visualiser/js/token.js"), __webpack_require__(/*! link */ "../itf-impl/Visualiser/js/link.js"), __webpack_require__(/*! box-wrapper */ "../itf-impl/Visualiser/js/box-wrapper.js"), __webpack_require__(/*! nodes/promo */ "../itf-impl/Visualiser/js/nodes/promo.js"), __webpack_require__(/*! nodes/const */ "../itf-impl/Visualiser/js/nodes/const.js"), __webpack_require__(/*! op */ "../itf-impl/Visualiser/js/op.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (Node, Token, Link, BoxWrapper, Promo, Const, Op) {
  ...
  var Link = __webpack_require__(/*! link */ "../itf-impl/Visualiser/js/link.js");
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! parser/token */ "../itf-impl/Visualiser/js/parser/token.js"), __webpack_require__(/*! parser/pattern */ "../itf-impl/Visualiser/js/parser/pattern.js"), __webpack_require__(/*! ast/pattern */ "../itf-impl/Visualiser/js/ast/pattern.js"), __webpack_require__(/*! ast/abstraction */ "../itf-impl/Visualiser/js/ast/abstraction.js"), __webpack_require__(/*! ast/application */ "../itf-impl/Visualiser/js/ast/application.js"), __webpack_require__(/*! ast/identifier */ "../itf-impl/Visualiser/js/ast/identifier.js"), __webpack_require__(/*! ast/constant */ "../itf-impl/Visualiser/js/ast/constant.js"), __webpack_require__(/*! ast/unary-op */ "../itf-impl/Visualiser/js/ast/unary-op.js"), __webpack_require__(/*! ast/binary-op */ "../itf-impl/Visualiser/js/ast/binary-op.js"), __webpack_require__(/*! ast/if-then-else */ "../itf-impl/Visualiser/js/ast/if-then-else.js"), __webpack_require__(/*! ast/recursion */ "../itf-impl/Visualiser/js/ast/recursion.js"), __webpack_require__(/*! ast/tuple */ "../itf-impl/Visualiser/js/ast/tuple.js"), __webpack_require__(/*! ast/provisional-constant */ "../itf-impl/Visualiser/js/ast/provisional-constant.js"), __webpack_require__(/*! ast/change */ "../itf-impl/Visualiser/js/ast/change.js"), __webpack_require__(/*! ast/assign */ "../itf-impl/Visualiser/js/ast/assign.js"), __webpack_require__(/*! ast/propagation */ "../itf-impl/Visualiser/js/ast/propagation.js"), __webpack_require__(/*! ast/deprecation */ "../itf-impl/Visualiser/js/ast/deprecation.js"), __webpack_require__(/*! ast/deref */ "../itf-impl/Visualiser/js/ast/deref.js"), __webpack_require__(/*! ast/graphabstraction */ "../itf-impl/Visualiser/js/ast/graphabstraction.js"), __webpack_require__(/*! op */ "../itf-impl/Visualiser/js/op.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (Token, PatternType, Pattern, Abstraction, Application, Identifier, Constant, UnaryOp, BinaryOp, IfThenElse, Recursion, Tuple, ProvisionalConstant, Change, Assign, Propagation, Deprecation, Dereference, GraphAbstraction, Op) {
  var BinOpType = Op.BinOpType;
  var UnOpType = Op.UnOpType;
  ...
  function () {
    ...
    _createClass(Parser, [{
      ...
      value: function isBinaryOp(token) {
        return token.type == Token.AND || token.type == Token.OR || token.type == Token.PLUS || token.type == Token.SUB || token.type == Token.MULT || token.type == Token.DIV || token.type == Token.LTE || token.type == Token.COMMA;
      }
    }, {
      key: "parseBinop",
      ...
      value: function atom(ctx) {
        if (this.lexer.skip(Token.LPAREN)) {
          ...
          return new GraphAbstraction(_term6);
        } else {
          return undefined;
        }
      }
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = (function () {
  ...
  'LAMBDA', 'LPAREN', 'RPAREN', 'CLPAREN', 'CRPAREN', 'LCID', 'DOT', 'COMMA', 'APP', 'LET', 'DEFINE', 'IN', 'REC', 'INT', 'TRUE', 'FALSE', 'NOT', 'AND', 'OR', 'PLUS', 'SUB', 'MULT', 'DIV', 'LTE', 'IF', 'THEN', 'ELSE', 'SET', 'CHANGE', 'TO', 'PROP', 'DEP', 'DEREF', 'ABS'].forEach(function (token) {
