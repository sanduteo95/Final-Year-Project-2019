module.exports = function (program, functionApplication) {
    let emptyAddress = 0;
    let printAddress = 1;
    let throwAddress = 2;
    ...
    function interpretContent (content, functionApplication) {
        ...
        if (content[0] === 'New') {
            return interpretVariableDeclaration(content, [], [], functionApplication);
        } else {
    ...
    return interpret(program, functionApplication);
}