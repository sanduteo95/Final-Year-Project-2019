...
runClosure = (path, code) => {
    const ClosureCompiler = require('google-closure-compiler').jsCompiler;
     
    // console.log(ClosureCompiler.toString())
...
runPrepack = (filePath, fileContents) => {
...
apply = (program, callback, file, maxTermCalls, addClosure, closureStrategy) => {
