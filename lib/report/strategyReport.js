...
const promiseToRunAllStrategies = (file, maxTermCall, language) => {
    return new Promise((resolve, reject) => {
        ...
        return boilerplate.futamura1Boilerplate('input/' + language + '/pp-' + file, code, maxTermCall, false, undefined, language === 'SSD')
            .then(futamuraFile0 => {
                ...
                return boilerplate.futamura1Boilerplate('input/' + language + '/cc-' + file, code, maxTermCall, true, 1, language === 'SSD')
            }).then(futamuraFile1 => {
                ...
                return boilerplate.futamura1Boilerplate('input/' + language + '/cc-pp-' + file, code, maxTermCall, true, 2, language === 'SSD')
            }).then(futamuraFile2 => {
                ...
                return boilerplate.futamura1Boilerplate('input/' + language + '/pp-cc-' + file, code, maxTermCall, true, 3, language === 'SSD')
            }).then(futamuraFile3 => {
                ...
                return boilerplate.futamura1Boilerplate('input/' + language + '/cc-pp-cc-' + file, code, maxTermCall, true, 4, language === 'SSD')
            }).then(futamuraFile4 => {
                ...
                return boilerplate.futamura1Boilerplate('input/' + language + '/pp-cc-pp-' + file, code, maxTermCall, true, 5, language === 'SSD')
            }).then(futamuraFile5 => {
