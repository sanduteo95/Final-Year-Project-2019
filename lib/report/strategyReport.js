    ...
    return new Promise((resolve, reject) => {
        ...
        return boilerplate.futamura1Boilerplate('input/' + language + '/' + file, maxTermCall, 0, language === 'SSD')
            .then(futamuraFile0 => {
                ...
                return boilerplate.futamura1Boilerplate('input/' + language + '/' + file, maxTermCall, 1, language === 'SSD')
            }).then(futamuraFile1 => {
                ...
                return boilerplate.futamura1Boilerplate('input/' + language + '/' + file, maxTermCall, 2, language === 'SSD')
            }).then(futamuraFile2 => {
                ...
                return boilerplate.futamura1Boilerplate('input/' + language + '/' + file, maxTermCall, 3, language === 'SSD')
            }).then(futamuraFile3 => {
                ...
                return boilerplate.futamura1Boilerplate('input/' + language + '/' + file, maxTermCall, 4, language === 'SSD')
            }).then(futamuraFile4 => {
                ...
                return boilerplate.futamura1Boilerplate('input/' + language + '/' + file, maxTermCall, 5, language === 'SSD')
            }).then(futamuraFile5 => {
