...
const grammar = {
    ...
    "bnf": {
        ...
        // the program consists of the program content
        "program": [
            [ "content",                                                                        "$$ = $content;" ]
        ],
        // the program content consists of global variables and a list of functions
        // the last thing in a program has to be a function application
        "content": [
            [ "type name = expression ; content",                                               "$$ = [\"New\", $name, $expression, $content];" ],
            [ "func_list func_appl ;",                                                           "$$ = [$func_list, $func_appl];" ],
            [ "func_list return func_appl ;",                                                    "$$ = [$func_list, [\"Return\", $func_appl]];" ]
        ],
