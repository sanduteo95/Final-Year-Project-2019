(function () {
    ...
    if (global.__isAbstract && global.__isAbstract(result)) {
      ...
      if (result !== undefined && result.type === 'Abstr') {
        ...
        _U_(null, function () {
          ...
          _J_(result, [], argumentAddresses, _K_, true);
        });
      } else {
        _U_(err, address > 1 && _O_(address));
      }
    }
  };
  ...
  var _2_ = function () {
    ...
    _J_(_3_, [], argumentAddresses, _K_, true);
  };
