(function () {
  ...
  var _1o_ = function (address, value) {
    var __captured__scope_2_ = __scope_0_main[1] || __get_scope_binding_0_get_95scope_95binding(1);

    __captured__scope_2_[0][address] = value;
  };

  var _1l_ = function (address) {
    var __captured__scope_2_ = __scope_0_main[1] || __get_scope_binding_0_get_95scope_95binding(1);
  ...
  var _1m_ = function (term, env, addressesToBind, callback, isRhsApplication) {
    var __captured__scope_2_ = __scope_0_main[1] || __get_scope_binding_0_get_95scope_95binding(1);
  ...
  var _V_ = function (abstraction, env, addressesToBind, callback, isRhsApplication) {
    false;
  ...
  var _W_ = function (application, env, addressesToBind, callback) {
    var __captured__scope_2_ = __scope_0_main[1] || __get_scope_binding_0_get_95scope_95binding(1);
  ...
  var _1q_ = function (identifier, env, callback) {
  ...
  var _S_ = function (dereference, env, addressesToBind, callback, isRhsApplication) {
    false;
  ...
  var _T_ = function (constant, callback) {
  ...
  var _1k_ = function (operator, lhsAddress, rhsAddress, callback) {
    let err = null;
  ...
  var _U_ = function (operator, env, addressesToBind, callback, isRhsApplication) {
    false;
        ...
        return {
          ...
          args: [null, function () {
            ...
            for (let i = 0; i < arguments.length; i++) {
              argumentAddresses.push(_1p_(arguments[i]));
            }

            return _V_(result, [], argumentAddresses, _3E_, true);
          }]
        };
      } else {
        return {
