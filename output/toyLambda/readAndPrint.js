(function () {
  ...
  var _j = function (term, boundVariables, variablesToBound, callback, isApplication) {
    ...
    switch (term[0]) {
      case 'Deref':
        _m(term[1], boundVariables, termCallback);

        break;

      case 'Const':
        _n(term[1], termCallback);

        break;

      case 'Op':
        _o(term[1], boundVariables, variablesToBound, termCallback, isApplication);

        break;

      case 'Abstr':
        _p(term[1], boundVariables, variablesToBound, termCallback, isApplication);

        break;

      case 'Apply':
        _q(term[1], boundVariables, variablesToBound, termCallback, isApplication);
  ...
  var _p = function (abstraction, boundVariables, variablesToBound, callback, isApplication) {
    var __captured__scope_1 = __scope_0[0] || __get_scope_binding_0(0);
    ...
    _j(abstraction[1], boundVariables, variablesToBound, abstrCallback, isApplication);
  };

  var _q = function (application, boundVariables, variablesToBound, callback, isApplication) {
    var __captured__scope_1 = __scope_0[0] || __get_scope_binding_0(0);
    ...
    const rhsCallback = function (err, address) {
      if (err) {
        ...
        switch (application[0][0]) {
          case 'Abstr':
          case 'Apply':
            _j(application[0], boundVariables, variablesToBound, lhsCallback, isApplication);

            break;

          case 'Deref':
            _j(application[0], boundVariables, variablesToBound, function (err, termAddress) {
              let term = undefined;
              ...
              if (err) {
                ...
                _j(term, boundVariables, variablesToBound, lhsCallback, isApplication);
              }
            }, isApplication);
    ...
    _j(application[1], boundVariables, [], rhsCallback, true);
  };
  ...
  var _s = function (identifier, boundVariables, callback) {
  ...
  var _m = function (dereference, boundVariables, callback) {
    var __captured__scope_1 = __scope_0[0] || __get_scope_binding_0(0);
    ...
    _s(dereference[1], boundVariables, function (err, address) {
      if (!err) {
        if (address === 1) {
          console.log(_4[1]);
        } else {
  ...
  var _n = function (constant, callback) {
    var __captured__scope_1 = __scope_0[0] || __get_scope_binding_0(0);
  ...
  var _t = function (operator, lhsAddress, rhsAddress, callback) {
    let err = null;
  ...
  var _o = function (operator, boundVariables, variablesToBound, callback, isApplication) {
    var __captured__scope_1 = __scope_0[0] || __get_scope_binding_0(0);
    ...
    const lhsOpCallback = function (err, lhsAddress) {
      ...
      const rhsOpCallback = function (err, rhsAddress) {
        ...
        _t(operator[0], lhsAddress, rhsAddress, callback);
      };
      ...
      if (operator[0] !== 'Negate' && operator[0] !== 'Negative') {
        ...
        if (operator[0] === 'Or' && _4[lhsAddress] || operator[0] === 'And' && !_4[lhsAddress]) {
          ...
          _j(operator[2], boundVariables, variablesToBound, rhsOpCallback, isApplication);
        }
      } else {
        rhsOpCallback();
      }
    ...
    _j(operator[1], boundVariables, variablesToBound, lhsOpCallback, isApplication);
  };

  var _k = function (err, address) {
    _l(err, _4[address !== 1 ? address : 0]);
  };
  ...
  var _C = function (err, address) {
    return $_0.call(this, _k, 0, err, address);
  };
  ...
  var _A = function (err, address) {
    ...
    if (err) {
      ...
      switch (_E[0][0]) {
        case 'Abstr':
        case 'Apply':
          _j(_E[0], _f, _D, lhsCallback, void 0);

          break;

        case 'Deref':
          _j(_E[0], _f, _D, function (err, termAddress) {
            let term = undefined;
            ...
            if (err) {
              ...
              _j(term, _f, _D, lhsCallback, void 0);
            }
          }, void 0);
  ...
  var _4 = [];
  var _D = [];
  var _E = [["Abstr", ["x", ["Apply", [["Abstr", ["_print", ["Deref", ["Identifier", "_print"]]]], ["Deref", ["Identifier", "x"]]]]]], ["Deref", ["Identifier", "_read"]]];
  var _f = {
    _print: {
      address: 1
    },
